...
namespace TiendaOnline.AppMVC.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(TiendaOnlineZapContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Estatus,FechaCreacion,FechaActualizacion")] Categoria categoria)
        {
